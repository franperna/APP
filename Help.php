    ...
    <body>
        <div id="bloc_page">
             ...
             <img id="life" src="Images site web/Fond/Fond8.jpg" alt="Photo de sport" title="Sport is life"/>
                 <article> 
                     <div id= "question"> <p> Question réccurente </br> </br>
                                         Sport?</br></br>
                                         Créer groupe
                                         </p>
                      </div></br></br>
...
if (!$resultat)
{
    $message1 = "Mauvais identifiant ou mot de passe";
                      echo '<script type="text/javascript">window.alert("' . $message1 . '"); window.location.href="Help.php";</script>';
}
else
{
    session_start();
    ...
    $message2 = "Vous êtes connecté";
                      echo '<script type="text/javascript">window.alert("' . $message2 . '"); window.location.href="Help.php";</script>';
}
}
/*<?php
